...
cout<<"\nDo you want to add more edges (Y=YES/N=NO)? : "; /* Type 'Y' or
'y' for YES and 'N' or 'n' for NO */
cin>>ans;
}while(ans=='y' || ans=='Y');
}
...
Total_cost=Total_cost+min; /* calculating cost of minimum spanning
tree */
